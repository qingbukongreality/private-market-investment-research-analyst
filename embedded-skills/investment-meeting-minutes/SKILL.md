...
- Treat a chunk Q&A whose information-bearing text is under roughly 55% of its source chunk as a likely omission signal. Run one source-grounded completion pass for that chunk; restore facts, explanations, examples, figures, qualifications and follow-up questions without retaining filler merely to satisfy a ratio.
